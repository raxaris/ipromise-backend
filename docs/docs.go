...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/follow/recommended": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Максимум пользователей",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.UserLiteResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/follow/requests/{username}/cancel": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username пользователя, которому был отправлен запрос",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "message: Запрос отменён",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/follow/{username}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username, кому отправить запрос",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "message: Follow request sent",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
                    ...
                    "400": {
                        "description": "error: Уже подписан или нельзя подписаться на себя",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username, от кого отписаться",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "message: Unfollowed successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
                    ...
                    "400": {
                        "description": "error: Не подписан на этого пользователя или пытаешься отписаться от себя",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/follow/{username}/accept": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username отправителя запроса",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "message: Follow request accepted",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
                    ...
                    "400": {
                        "description": "error: Нет ожидающего запроса от пользователя",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/follow/{username}/decline": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message: Follow request declined",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
        ...
        "/friends/{username}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username пользователя, чьих друзей получить",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Список взаимных друзей",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
        ...
        "/posts": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID промиса (опционально)",
                        "name": "promise_id",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "file",
                        "description": "Вложения (можно несколько)",
                        "name": "attachments",
                        "in": "formData"
                    }
                ],
        ...
        "/posts/{id}/attachments": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Файлы (можно несколько)",
                        "name": "attachments",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "error: Неверный ID или формат",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/posts/{id}/comments": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "message: Комментарий создан",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/posts/{id}/like": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message: Пост лайкнут",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/posts/{id}/unlike": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message: Лайк удалён",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
