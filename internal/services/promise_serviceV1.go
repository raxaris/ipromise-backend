...
type PromiseServiceV1 interface {
...
type promiseServiceV1 struct {
	repo     repositories.PromiseRepositoryV1
	userRepo user.UserRepository
}

func NewPromiseServiceV1(repo repositories.PromiseRepositoryV1, userRepo user.UserRepository) PromiseServiceV1 {
	return &promiseServiceV1{
		repo:     repo,
		userRepo: userRepo,
	}
}

func (s *promiseServiceV1) Create(userID uuid.UUID, req dto.CreatePromiseRequest) error {
...
func (s *promiseServiceV1) createMainPromise(userID uuid.UUID, req dto.CreatePromiseRequest) error {
	if req.Deadline == nil {
...
func (s *promiseServiceV1) createProgress(userID uuid.UUID, req dto.CreatePromiseRequest) error {
...
func (s *promiseServiceV1) GetByUserID(userID uuid.UUID) ([]models.PromiseV1, error) {
	return s.repo.GetByUserID(userID)
}

func (s *promiseServiceV1) GetPublic() ([]models.PromiseV1, error) {
	return s.repo.GetAllPublic()
}

func (s *promiseServiceV1) GetByID(id uuid.UUID) (*models.PromiseV1, error) {
	return s.repo.GetByID(id)
}

func (s *promiseServiceV1) GetPublicByUserID(userID uuid.UUID) ([]models.PromiseV1, error) {
	return s.repo.GetPublicByUserID(userID)
}

func (s *promiseServiceV1) GetAllPromisesForAdmin() ([]models.PromiseV1, error) {
	return s.repo.GetAll()
}

func (s *promiseServiceV1) GetChildren(parentID uuid.UUID) ([]models.PromiseV1, error) {
	return s.repo.GetChildren(parentID)
}

func (s *promiseServiceV1) Update(userID uuid.UUID, id string, req dto.UpdatePromiseRequest, isAdmin bool) error {
...
func (s *promiseServiceV1) Delete(userID uuid.UUID, promiseID uuid.UUID, isAdmin bool) error {
